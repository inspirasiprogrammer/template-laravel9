						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right">
										<a href="{{ route('admin.admin.edit',$row->id) }}" class="btn btn-primary btn-sm">{{ __('Edit') }}</a>
										<a href="#" data-action="{{ route('admin.admin.destroy',$row->id) }}" class="btn btn-primary btn-sm delete-confirm">{{ __('Delete') }}</a>
									</td>
								</tr>
								@endforeach
							</tbody>
