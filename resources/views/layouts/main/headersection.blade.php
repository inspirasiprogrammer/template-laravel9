    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <button type="button" {!! $button['components'] ?? '' !!} class="btn btn-sm btn-primary">{!! $button['name'] ?? '' !!}</button>
          @else
          <a href="{{ $button['url'] ?? '' }}" {!! $button['components'] ?? '' !!} class="btn btn-sm btn-primary">{!! $button['name'] ?? '' !!}</a>
          @endif
          @else
          <a href="{{ $button['url'] ?? '' }}" {!! $button['components'] ?? '' !!} class="btn btn-sm btn-primary">{!! $button['name'] ?? '' !!}</a>
          @endif
